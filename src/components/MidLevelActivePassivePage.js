...
const MidLevelActivePassivePage = () => {
  ...
  const getActiveToPassiveFeedback = (
    ...
    let objectDiagnosis = actpassFeedbackProps.object_Diagnosis;
    let subjectDiagnosis = actpassFeedbackProps.subject_Diagnosis;
    let useOfByDiagnosis = actpassFeedbackProps.useOfBy_Diagnosis;
    let mainVerbDiagnosis = actpassFeedbackProps.mainVerb_Diagnosis;
    let helpingVerbDiagnosis = actpassFeedbackProps.helpingVerb_Diagnosis;
    let objectRemedy = actpassFeedbackProps.object_Remedy;
    let subjectRemedy = actpassFeedbackProps.subject_Remedy;
    let useOfByRemedy = actpassFeedbackProps.useOfBy_Remedy;
    let mainVerbRemedy = actpassFeedbackProps.mainVerb_Remedy;
    let helpingVerbRemedy = actpassFeedbackProps.helpingVerb_Remedy;
    ...
    /*var subjectArticle = ActivityPojo.subject_article;
      ...
      var objectArticle = ActivityPojo.object_article;
      var objectName = ActivityPojo.object_name;*/
    var subjectArticle = ActivityPojo.object_article;
    var subjectName = ActivityPojo.object_name;
    var objectArticle = ActivityPojo.subject_article;
    var objectName = ActivityPojo.subject_name;
...
export default MidLevelActivePassivePage;
