        ...
        <ol type="A">
          ...
          <ol>
            ...
            <ul type="disc">
              ...
              <li>
                In the Present Perfect tense, the action is complete or has
          ...
          <ol>
            ...
            <ul type="disc">
              ...
              <li>
                The action started and ended sometime in the past but the time
            ...
            <ul type="disc">
              ...
              <li>
                This tense is used to talk about an action at a particular time
                in the past.
              </li>
              <li className="fw-bolder">For example</li>
              <ol type="i">
            ...
            <ul type="disc">
              <li>
                An action that happened before a certain time in the past, to
                show duration.
              </li>
              <li>
              ...
              <ol type="i">
                <li>
                  I had been going to school for a year when it was closed.
                </li>
          ...
          <ol>
            ...
            <ul type="disc">
              ...
              <li>
                The Simple Future tense is used when we plan or make a decision
                to do something.
              </li>
