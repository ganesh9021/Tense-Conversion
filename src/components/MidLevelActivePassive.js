  ...
  return (
    <>
     <OlabsPage
        ...
        RSM_ok="OK"
        M_midcontent_comp={<MidLevelActivePassivePage />}
...
export default MidLevelActivePassive;
